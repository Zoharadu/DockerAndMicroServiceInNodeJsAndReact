...
const group_router_1 = require("./group/group.router");
const express_1 = __importDefault(require("express"));
const middleWare_1 = require("./utils/middleWare");
const cors_1 = __importDefault(require("cors"));
const config_1 = require("./config");
const group_repository_1 = __importDefault(require("./group/group.repository"));
const appServer = (0, express_1.default)();
exports.appServer = appServer;
appServer.use(express_1.default.json());
appServer.use((0, cors_1.default)({ origin: "*" }));
appServer.use("/api/group", group_router_1.appGroup);
...
function creatDataBase() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        group_repository_1.default.createGroupsDocuments();
        return connect;
    });
}
